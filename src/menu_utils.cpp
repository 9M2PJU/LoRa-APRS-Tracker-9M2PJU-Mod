...
//////////            
            ...
            case 210:   // 2.Configuration ---> Change Frequency
                switch (loraIndex) {
                    case 0: freqChangeWarning = "      MY --> MY"; break;
                    case 1: freqChangeWarning = "      MY --> MY"; break;
                    case 2: freqChangeWarning = "      MY --> MY"; break;
                }
...
//////////
            case 30:     // 3. Reports : Wx Report
                displayShow(" REPORTS >","> 1.Wx Report", "  2.Repeater Info", "  3.ISS Pass", "  4.Current QTH", lastLine);
                break;
