...
namespace KEYBOARD_Utils {
    ...
    void rightArrow() {
        if (menuDisplay == 0 || menuDisplay == 200) {
            ...
            logger.log(logging::LoggerLevel::LOGGER_LEVEL_INFO, "Loop", "%s", "REPEAT: Nearest 3");
            MSG_Utils::addToOutputBuffer(0, "REPEAT", "nearest 3");
        } else if (menuDisplay == 32) {
            logger.log(logging::LoggerLevel::LOGGER_LEVEL_INFO, "Loop", "%s", "9M2PJU-4 : Satpass");
            MSG_Utils::addToOutputBuffer(0, "9M2PJU-4", "satpass iss");
        } else if (menuDisplay == 33) {
            logger.log(logging::LoggerLevel::LOGGER_LEVEL_INFO, "Loop", "%s", "9M2PJU-4: Current QTH");
            MSG_Utils::addToOutputBuffer(0, "9M2PJU-4", "whereami");
        }
