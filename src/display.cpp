...
void displayShow(const String& header, const String& line1, const String& line2, int wait) {
            ...
            sprite.fillSprite(TFT_BLACK); 
            sprite.fillRect(0, 0, 160, 19, greenColor);
            sprite.setTextFont(0);
            sprite.setTextSize(bigSizeFont);
            sprite.setTextColor(TFT_WHITE, greenColor);
...
void startupScreen(uint8_t index, const String& version) {
    ...
    switch (index) {
        ...
        case 1: workingFreq += "MY]"; break;
        case 2: workingFreq += "MY]"; break;
    }
    displayShow(" LoRa APRS", "      (TRACKER)", workingFreq, "", "", String("  9M2PJU  Mod"), 4000);
